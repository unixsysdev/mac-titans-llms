...
def test_context_length(target_tokens):
    ...
    try:
        ...
        # CRITICAL: Include the context IN the query prompt!
        # This is how normal retrieval works - the context is part of the input
        prompt_with_context = full_context + "\n\n" + query

        print(f"Generating response...")
        response = wrapper.generate(prompt_with_context, max_new_tokens=50)
...
if __name__ == "__main__":
    ...
    print("Context is included IN the prompt (correct methodology)")
    print("="*70)
